...
<div id="introduction"><h2 id="intro" class="list">Introduction <span class="backlink"> back to <a href="#toc">ToC</a></span></h2>
    <span class="markdown">This is a place holder text for the introduction. The introduction should briefly describe the ontology, its motivation, state of the art and goals.</span>
    <div id="namespacedeclarations">
        ...
        <div id="ns" align="center">
            <table>
                ...
                <tbody>
                <tr><td><b>{{strtolower($schema['label'] ?? '')}}</b></td><td>&lt;{{$schema['uri'] ?? ''}}&gt;</td></tr>
                <tr><td></td><td></td></tr>
